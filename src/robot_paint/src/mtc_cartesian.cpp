...
//Defining the function to get the shortest solution among multiple planners
...
{
  // Find the solution with the shortest path
  auto const shortest_solution = std::min_element(solutions.begin(), solutions.end(),
    [](const auto& solution_a, const auto& solution_b) {
...
#pragma GCC diagnostic pop
  ...
  auto stage_state_current = std::make_unique<mtc::stages::CurrentState>("ready");
  current_state_ptr = stage_state_current.get();
  task.add(std::move(stage_state_current));

  //To run parallel planners
