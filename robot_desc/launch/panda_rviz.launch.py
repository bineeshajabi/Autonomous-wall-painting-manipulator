...
Describer:  Launch the panda robot model in RViz
...
def generate_launch_description():
	...
	#Define filenames
	pkg_arm = 'robot_desc'
	urdf_desc_file='robot_model.urdf.xacro'
	rviz_file = 'panda.rviz'
	...
	joint_state_publisher_gui_arm=Node(
		...
		name='joint_state_publisher_gui_painter_arm',
		output='screen'		
	)
