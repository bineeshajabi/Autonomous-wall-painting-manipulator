...
for controlling a robotic arm using MoveIt 2. It loads configuration files,
...
def generate_launch_description():
    ...
    pkg_moveit_config = 'robot_moveit_config'
    ...
    pkg_share_moveit_config_temp = FindPackageShare(package=pkg_moveit_config)
    ...
    declare_rviz_config_package_cmd = DeclareLaunchArgument(
        ...
        default_value=pkg_moveit_config,
    ...
    def configure_setup(context):
        ...
        # Get package path
        pkg_share_moveit_config = pkg_share_moveit_config_temp.find(pkg_moveit_config)
        ...
        return [start_move_group_node_cmd, start_rviz_node_cmd]
